    ...
    <section class="h-screen w-screen grid place-items-center p-8">
        <div class="w-full bg-accent rounded-lg shadow mx-8 md:w-1/2">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                <h1 class="text-xl font-bold tracking-tight text-center md:text-2xl text-primary">
                    Golden Finger
                </h1>
                <form class="space-y-4 md:space-y-6" action="{{url('')}}" method="post">
                    ...
                    <button type="submit" class="btn btn-primary btn-block text-black">Sign In</button>
                </form>
            </div>
        </div>
      </section>
