...
@section('content')
<h1 class="text-2xl font-bold mb-5">Laporan Pembelian</h1>
<div class="bg-accent p-4 rounded my-5">
    <form action="{{ url('/laporan/pembelian') }}" method="GET">
    ...
    <div class="overflow-x-auto mt-5">
        <table class="table-zebra data-table">
            ...
            <tbody>
                ...
                @else
                <tr>
                    <th class="text-error text-lg text-center" colspan="6">Tidak ada data...</th>
                </tr>
                @endif
            </tbody>
        </table>
...
@if ($mulai != null)
<div class="my-5">
    <a href="{{ url("/laporan/pembelian/pdf?mulai=$mulai&akhir=$akhir") }}">
