    ...
    <form method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-5">
            <div class="form-control w-full">
                ...
                <input type="text" placeholder="B001..." class="input   w-full" name="nama" value="{{ $user->nama }}"/>
            </div>
            <div class="form-control w-full">
                <label class="label">
                ...
                <input type="text" placeholder="B001..." class="input   w-full" name="role" value="{{ $user->role }}" disabled/>
            </div>
            <div class="form-control w-full">
                <label class="label">
                ...
                <input type="text" placeholder="B001..." class="input   w-full" name="username" value="{{ $user->username }}" required/>
            </div>
            <div class="form-control w-full">
                <label class="label">
                ...
                <input type="text" placeholder="B001..." class="input   w-full" name="telp" value="{{ $user->telp }}" required/>
            </div>
...
<div class="p-4 rounded-2xl bg-accent shadow mt-5">
    <form method="POST" action="{{ url('profile/password-update') }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-5">
            <div class="form-control w-full">
                ...
                <input type="text" class="input   w-full" name="new-password" required/>
            </div>
            <div class="form-control w-full">
                <label class="label">
                ...
                <input type="text" class="input   w-full" name="old-password" required/>
            </div>
        </div>
        <button class="btn btn-primary">Simpan</button>
    </form>
