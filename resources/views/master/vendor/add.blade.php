    ...
    <form method="POST">
        ...
        <div class="flex flex-wrap mb-5">
            ...
            <div class="form-control w-full md:w-1/2">
                ...
                <input type="text" placeholder="vendor@gmail.com" class="input   w-full" name="email" required/>
            </div>
            <div class="form-control w-full md:w-1/2 md:pe-2">
                <label class="label">
            ...
            <div class="form-control w-full md:w-1/2">
                ...
                <input type="text" placeholder="Jalan..." class="input   w-full" name="alamat" required/>
            </div>
            <div class="form-control w-full md:w-1/2 md:pe-2">
                <label class="label">
                ...
                <input type="text" placeholder="Kota..." class="input   w-full" name="kota" required/>
            </div>
            <div class="form-control w-full md:w-1/2">
                <label class="label">
                ...
                <input type="text" placeholder="NPWP..." class="input   w-full" name="npwp" required/>
            </div>
        </div>
