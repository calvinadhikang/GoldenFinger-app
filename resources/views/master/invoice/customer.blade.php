        ...
        <form method="POST" action="{{ url('invoice/customer/new') }}">
            ...
            <div class="flex flex-wrap">
                <div class="form-control w-full md:w-1/2 md:pe-2">
                    ...
                    <input type="text" placeholder="Nama..." class="input   w-full" name="nama" value="{{ old('nama') }}" />
                </div>
                <div class="form-control w-full md:w-1/2">
                    ...
                    <input type="email" placeholder="...@..." class="input   w-full" name="email" value="{{ old('email') }}" />
                </div>
                <div class="form-control w-full md:w-1/2 md:pe-2">
                    <label class="label">
                    ...
                    <input type="text" placeholder="Jalan..." class="input   w-full" name="alamat" value="{{ old('alamat') }}" />
                </div>
                <div class="form-control w-full md:w-1/2">
                    <label class="label">
                    ...
                    <input type="text" placeholder="081..." class="input   w-full" name="telp" value="{{ old('telp') }}" />
                </div>
                <div class="form-control w-full md:w-1/2 md:pe-2">
                    <label class="label">
                    ...
                    <input type="text" placeholder="Kota..." class="input   w-full" name="kota" value="{{ old('kota') }}" />
                </div>
                <div class="form-control w-full md:w-1/2">
                    <label class="label">
                    ...
                    <input type="text" placeholder="001.002.003" class="input   w-full" name="NPWP" value="{{ old('NPWP') }}" />
                </div>
            </div>
