...
@section('content')
    ...
    <div role="tablist" class="tabs tabs-boxed w-fit mt-5 bg-accent font-semibold">
        <a role="tab" href="/invoice?type=unconfirmed" class="tab {{ $type == 'unconfirmed' ? 'tab-active' : '' }}"">
            <div class="indicator">
                Perlu Konfirmasi
        ...
        <a role="tab" href="/invoice?type=canceled" class="tab {{ $type == 'canceled' ? 'tab-active' : '' }}"">Invoice
            Dibatalkan</a>
