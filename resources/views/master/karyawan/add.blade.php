    ...
    <form method="POST" action="">
        ...
        <div class="flex flex-wrap mb-5">
            <div class="form-control w-full">
                ...
                <input type="text" placeholder="Joko.." class="input   w-full" name="nama" required/>
            </div>
            <div class="form-control w-full md:w-1/2 md:pe-2">
                ...
                <input type="password" placeholder="password" class="input   w-full" name="password" required/>
            </div>
            <div class="form-control w-full md:w-1/2">
                ...
                <input type="text" placeholder="username" class="input   w-full" name="username" required/>
            </div>
            <div class="form-control w-full">
                <label class="label">
                ...
                <input type="text" placeholder="081..." class="input   w-full" name="telp" required/>
            </div>
            <div class="form-control w-full">
                <label class="label">
                ...
                <select class="select input   w-full" name="role" required>
